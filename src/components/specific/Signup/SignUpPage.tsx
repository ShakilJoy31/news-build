...
import logoIcon from "../../../../public/icons/register.png";
          ...
          <div className="w-full max-w-[600px] mx-auto py-10 px-5 bg-gray-100 shadow-md rounded-md">
            <div className="px-4 my-7">
              <div className="flex items-center justify-center gap-3">
                ...
                <h3 className="text-3xl font-bold uppercase mt-2">Register</h3>
              </div>
              <br />
              <br />
              {authError && (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    <FaEnvelope className="absolute left-5 top-1/2 transform -translate-y-1/2 text-gray-400" />
                    <input
                      id="phone"
                      name="phone"
                      type="text"
